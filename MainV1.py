...
class NewsProcessor:
    ...
    def run_complete_pipeline(self, search_query, target_search=None):
...
if __name__ == "__main__":
    ...
    processor = NewsProcessor(model='mistral')
    processor.run_complete_pipeline(SEARCH_QUERY, TARGET_SEARCH)
